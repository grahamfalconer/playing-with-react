...
class IdentityGenerator extends Component {
  ...
  render() {
    return (
      <div className="IdentityGenerator" class="center">
        ...
        <div>
            ...
            <div >
              <div class="container">
                ...
                { "Age: " + this.state.person.dob.age} &nbsp; { "Born on: " + this.state.person.dob.date } <br />
            ...
            { "Phone Number: " + this.state.person.cell } &nbsp; { "Instagram: " + this.state.person.login.username }  <br /> 
